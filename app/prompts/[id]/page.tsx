...
const promptsData: Record<string, { title: string; content: string }> = {
  "1": {
    title: "Prompt 1",
    content: `Build a single full-viewport hero section in React + TypeScript + Vite + Tailwind CSS, using \`lucide-react\` for icons. The component is a character-figurine carousel called "TOONHUB".
