...
Display font (huge ghost text + bottom-right link): 'Anton', sans-serif.
...
- bump \`activeIndex\` \`(prev+1)%4\` or \`(prev+3)%4\`
- release lock after \`650ms\`
...
- zIndex 3
- map all 4 IMAGES
- each item is \`position:absolute\`
- \`aspectRatio: '0.6 / 1'\`
